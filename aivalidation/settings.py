"""
Django settings for aivalidation project.
...
SECRET_KEY = 's2loq4y4-$k^&l*h@$9wena!m*ccns-urvgmocs7ystiu-&_sx'
...
ROOT_URLCONF = 'aivalidation.urls'
...
WSGI_APPLICATION = 'aivalidation.wsgi.application'
...
MLFLOW_URL = "http://{}:{}".format(MLFLOW_IP, MLFLOW_PORT)
